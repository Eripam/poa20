        ...
        dataType: 'json'
            ...
            .done(function (response) {
                $.each(response, function () {
                    ...
                    if ((tusu === "3" && estadof === 2) || (tusu === "4" && (estadof === 4 || estadof === 8 || estadof === 9)) || ((tusu === "7" || tusu === "8") && (estadof === 6 || estadof === 23 || estadof === 24)) || (tusu === "19" && (estadof === 2 || estadof === 9 || estadof === 10)) || (tusu === "5" && (estadof === 2 || estadof === 9)) || ((tusu === "16" || tusu === "17") && estadof === 6) || (tusu === "11" && (estadof === 11 || estadof === 21 || estadof === 22 || estadof === 2 || estadof === 9))) {
                            ...
                            $.each(this.req, function (indice, r) {
                                ...
                                if (r.tc_id < 1) {
                                    ...
                                    if (r.req_verificacion === 2) {
                                        ...
                                        if (estadof === 16 || estadof === 17 || estadof === 18) {
                                            if (r.req_prioridad === 1) {
                                                pac = '<i class="far fa-eye" title="Ver Requerimientos" id="verReq" data-valor="' + i + '" data-req="' + this.req_id + '"></i><i class="far fa-paper-plane" id="verestadosreq" data-req="' + r.req_id + '"></i><i class="fas fa-check"></i>';
                                            } else {
