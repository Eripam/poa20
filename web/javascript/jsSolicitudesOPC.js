...
function listaSolicitud(t) {
    ...
    $.ajax({
        url: "../solicitud?accion=ListaSolicitudesOPC",
        type: 'POST',
        data: {area: $('#areaPadre').val(), anio: anio},
        dataType: 'json'
    })
            .done(function (response) {
                var total = 0, tipousu = $('#tipoUsuario').val();
                ;
                $.each(response, function () {
                    ...
                    if (this.solicitud_codigo === null || this.solicitud_codigo == null || this.solicitud_codigo == "") {
                        ...
                        codigo = '0' + this.solicitud_codigo + '-STP-' + anio;
                    }
                    var div;
                    if ((this.solicitud_estado === 0 || this.solicitud_estado === 14) && tipousu !== 23) {
                        div = '<a href="#" title="Visualizar Solicitud" class="icon_sol" id="visualReq" data-sol="' + this.solicitud_id + '" data-observacion="' + this.actividad_nombre + '" data-tsid="' + this.tc_id + '" data-tsnombre="' + this.tc_nombre + '"><i class="fas fa-eye"></i></a>\n\
                        ...
                        div = '<a href="#" title="Visualizar Solicitud" class="icon_sol" id="visualReq" data-sol="' + this.solicitud_id + '" data-observacion="' + this.actividad_nombre + '" data-tsid="' + this.tc_id + '" data-tsnombre="' + this.tc_nombre + '"><i class="fas fa-eye"></i></a><a href="#" title="Agregar Requerimientos" class="icon_sol" id="agregReq" data-sol="' + this.solicitud_id + '"><i class="fas fa-plus-circle"></i></a>\n\
                        <a href="#" title="Editar Solicitud" class="icon_sol" id="modJusti" data-sol="' + this.solicitud_id + '" data-observacion="' + this.actividad_nombre + '" data-tsid="' + this.tc_id + '" data-tsnombre="' + this.tc_nombre + '"><i class="fas fa-pencil-alt"></i></a><a href="#" title="Eliminar Solicitud" class="icon_sol" id="elimSol" data-solicitud="' + this.solicitud_id + '"><i class="fas fa-trash-alt"></i></a><a href="#" title="Enviar Solicitud" class="icon_sol" id="enviarSol" data-solicitud="' + this.solicitud_id + '" data-estado="' + this.solicitud_estado + '"><i class="fas fa-location-arrow"></i></a>\n\
                        <a href="#" title="Listar Fechas de Envio" class="icon_sol" id="listarFechas" data-sol="' + this.solicitud_id + '"><i class="far fa-calendar-alt"></i></a>';
                        ...
                        div = '<a href="#" title="Visualizar Solicitud" class="icon_sol" id="visualReq" data-sol="' + this.solicitud_id + '" data-observacion="' + this.actividad_nombre + '" data-tsid="' + this.tc_id + '" data-tsnombre="' + this.tc_nombre + '"><i class="fas fa-eye"></i></a><form method="POST" action="../controladorReportePDF" id="FrmDescargarSol' + this.solicitud_id + '" class="instructivos_archivos_icono" target="_blank" style="margin:0; padding:0;" onclick="activarPDF(' + this.solicitud_id + ');"><input type="hidden" value="reporteSolicitudOP" name="accion"><input type="hidden" name="idjustificativo" id="idjustificativo" value="' + this.solicitud_id + '"><input type="hidden" name="idestadojust" id="idestadojust" value="' + this.solicitud_estado + '"><a href="#" title="Descargar Solicitud" class="icon_sol" id="descargarJust" data-sol="' + this.solicitud_id + '">\n\
                        <input type="hidden" id="anioid" name="anioid" value="' + $('#selectanio').val() + '"><input type="hidden" id="agnombrepdf" name="agnombrepdf" value="' + $('#nombreAg').val() + '"><i class="fas fa-file-download"></i></a></form>\n\
                        <a href="#" title="Listar Fechas de Envio" class="icon_sol" id="listarFechas" data-sol="' + this.solicitud_id + '"><i class="far fa-calendar-alt"></i></a>';
                    } else if (this.solicitud_estado === 15 && tipousu == 23) {
                        div = '<a href="#" title="Visualizar Solicitud" class="icon_sol" id="visualReq" data-sol="' + this.solicitud_id + '" data-observacion="' + this.actividad_nombre + '" data-tsid="' + this.tc_id + '" data-tsnombre="' + this.tc_nombre + '"><i class="fas fa-eye"></i></a><form method="POST" action="../controladorReportePDF" id="FrmDescargarSolTH' + this.solicitud_id + '" class="instructivos_archivos_icono" target="_blank" style="margin:0; padding:0;" onclick="activarPDFTH(' + this.solicitud_id + ');"><input type="hidden" value="reporteSolicitudTHOP" name="accion"><input type="hidden" name="idjustificativoTH" id="idjustificativoTH" value="' + this.solicitud_id + '"><input type="hidden" name="idestadojustTH" id="idestadojustTH" value="' + this.solicitud_estado + '"><a href="#" title="Descargar Solicitud" class="icon_sol" id="descargarJust" data-sol="' + this.solicitud_id + '">\n\
                        <input type="hidden" id="anioid" name="anioid" value="' + $('#selectanio').val() + '"><input type="hidden" id="agnombrepdf" name="agnombrepdf" value="' + $('#nombreAg').val() + '"><i class="fas fa-file-download"></i></a></form>\n\
                        <a href="#" title="Listar Fechas de Envio" class="icon_sol" id="listarFechas" data-sol="' + this.solicitud_id + '"><i class="far fa-calendar-alt"></i></a>';
                    } else if (this.solicitud_estado === 1 && tipousu == 22) {
                        div = '<a href="#" title="Visualizar el Justificativo" class="icon_sol" id="visualReq" data-sol="' + this.solicitud_id + '" data-observacion="' + this.actividad_nombre + '" data-tsid="' + this.tc_id + '" data-tsnombre="' + this.tc_nombre + '"><i class="fas fa-eye"></i></a>\n\
        ...
        async: false
            ...
            .done(function (response) {
                $.each(response, function () {
                    ...
                    addID = tm.row.add(['<div style="text-align:justify;">' + this.ag_nombre + '</div>', '<div>' + tipo + '</div>', '<div>OEI-' + this.perspectiva_id + '</div>', '<div class="text-justify">' + this.proyecto_nombre + '</div>',
                        ...
                        '<div style="text-align:center;">' + new Intl.NumberFormat("US", options2).format(this.req_costo_total) + '</div>', '<div>' + this.presupuesto_fuente + '</div>', '<div class="dat"><input type="checkbox" name="reqfinmod" id="reqfinmod" data-id="' + this.req_id + '" data-monto="' + this.req_costo_unitario + '" data-anticipo="' + this.req_costo_total + '" data-iva="' + this.req_costo_sin_iva + '" \n\
                            data-nombre="' + this.req_nombre + '" data-oei="' + this.perspectiva_id + '" data-proyecto="' + this.presupuesto_proyecto + '" data-fuente="' + this.presupuesto_fuente + '" data-tipo="' + this.tc_id + '"></div>']).draw(false);
...
$('#example').on('click', 'tr td #visualReq', function () {
    ...
    $.ajax({
        url: "../solicitud?accion=ListarSolicitudSolicitudOPC",
        type: 'POST',
        data: {solicitud: data['sol']},
        dataType: 'json'
    })
            .done(function (response) {
                var num = 1, total = 0, tipo, div;
                $.each(response, function () {
                    total += this.req_costo_unitario + this.req_costo_sin_iva + this.req_costo_total;
                    if (this.tc_id === 1) {
                        tipo = 'OBLIGACIONES PENDIENTES';
                    } else {
                        tipo = 'COMPROMETIDOS NO DEVENGADOS';
                    ...
                    $('#listaRequerimientosSolVis').append('<tr><td>' + tipo + '</td><td class="text-center">OEI-0' + this.perspectiva_id + '</td><td>' + this.req_nombre + '</td>\n\
...
$('#listaRequerimientosSolVis').on('click', 'tr td#servprof', function () {
    ...
    if (data['estado'] === 15 || data['estado'] === 34) {
        $.ajax({
            url: "../solicitud?accion=ListarServiciosSolicitud",
            type: 'POST',
            data: {solicitud: data['sol'], requerimiento: data['req']},
            dataType: 'json'
        })
                .done(function (response) {
        ...
        $.ajax({
            url: "../solicitud?accion=ListarPersonalO",
            type: 'POST',
            data: {requerimiento: data['req']},
            dataType: 'json'
        })
                .done(function (response) {
                    var tipo, fi, ff, iva2, total = 0, codigo;
...
$('#modalGuardarJustAgreg').on('click', function () {
    ...
    $.ajax({
        url: "../solicitud?accion=AgregarRequerimientosOPC",
        type: 'POST',
        data: formData,
        dataType: 'json',
        cache: false,
    ...
    $.ajax({
        ...
        dataType: 'json'
            ...
            .done(function (response) {
                var num = 1, total = 0;
                $.each(response, function () {
                    var color, tipo, monto, iva, anticipo, tipous = $('#tipoUsuario').val();;
                    if (num % 2 === 0) {
                    ...
                    if (tipous === '23') {
                        if (this.tc_id === 1) {
                            tipo = 'OBLIGACIONES PENDIENTES';
                            monto = '<input type="hidden" size="40" class="form-control" name="monto' + this.req_id + '" class="input" value="' + this.req_costo_unitario + '">'+new Intl.NumberFormat("US", options2).format(this.req_costo_unitario);
                            iva = '<input type="hidden" size="40" class="form-control" name="iva' + this.req_id + '" class="input" value="' + this.req_costo_sin_iva + '">'+new Intl.NumberFormat("US", options2).format(this.req_costo_sin_iva);
                            anticipo = new Intl.NumberFormat("US", options2).format(this.req_costo_total);
                        } else {
                            tipo = 'COMPROMETIDOS NO DEVENGADOS';
                            monto = '<input type="text" size="40" class="form-control" name="monto' + this.req_id + '" class="input" value="' + this.req_costo_unitario + '">';
                            iva = new Intl.NumberFormat("US", options2).format(this.req_costo_sin_iva);
                            anticipo = '<input type="text" size="40" class="form-control" name="anticipo' + this.req_id + '" class="input" value="' + this.req_costo_total + '">';
                        }
                    } else {
                        if (this.tc_id === 1) {
                            tipo = 'OBLIGACIONES PENDIENTES';
                            monto = '<input type="text" size="40" class="form-control" name="monto' + this.req_id + '" class="input" value="' + this.req_costo_unitario + '">';
                            iva = '<input type="text" size="40" class="form-control" name="iva' + this.req_id + '" class="input" value="' + this.req_costo_sin_iva + '">';
                            anticipo = new Intl.NumberFormat("US", options2).format(this.req_costo_total);
                        } else {
                            tipo = 'COMPROMETIDOS NO DEVENGADOS';
                            monto = '<input type="text" size="40" class="form-control" name="monto' + this.req_id + '" class="input" value="' + this.req_costo_unitario + '">';
                    ...
                    $('#listaRequerimientosSol').append('<tr><td>' + tipo + '</td><td>' + this.perspectiva_id + '</td>\n\
                        <td>' + this.req_nombre + '</td>\n\
                        <td>' + monto + '</td>\n\
                        <td>' + iva + '</td>\n\
                        <td>' + anticipo + '</td>\n\
                        <td><input type="hidden" value="' + this.presupuesto_proyecto + '" name="proypres' + this.req_id + '" id="proypres' + this.req_id + '"><input type="checkbox" value="' + this.req_id + '" name="re" id="re" checked="checked" data-proyecto="' + this.perpectiva_proyecto + '"></td>\n\
                    </tr>');
                    num++;
                });
...
$('#modalGuardarJustMod').on('click', function () {
    ...
    var req = JSON.stringify(re);
    if (descripcion === "") {
        alert("Debe ingresar la motivaci\u00f3n");
    } else {
        var formData = new FormData();
        ...
        $.ajax({
            url: "../solicitud?accion=ModificarSolicitudOPC",
            type: 'POST',
            data: formData,
            dataType: 'json',
            cache: false,
...
$('#modalElSolicitud').on('click', function () {
    $.ajax({
        url: "../solicitud?accion=EliminarSolicitudOPC",
        type: 'POST',
...
$('#modalEnvJust').on('click', function () {
    $.ajax({
        url: "../solicitud?accion=EnviarSolicitudOPC",
        type: 'POST',
        data: {idSolicitud: $('#idsolicitudenviar').val(), cedula: $('#cedulaP').val(), estado: $('#idestadoenviar').val(), observacion: null},
        dataType: 'json'
    })
            .done(function (response) {
                if (response === "Correcto") {
