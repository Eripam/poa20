...
$('#selectareas').change(function () {
    ...
    var tipo, tp = $('#tipousuarioinput').val();
    ...
    $.ajax({
        url: "../proyecto?accion=ListaProyectoEvaluacionL",
        type: 'POST',
        data: {tipousuario: tp, area: $(this).val(), tipoproyecto: tipo, cuatrimestre: $('#cuatrieval').val(), anio:$('#selectanio').val()},
        dataType: 'json'
    })
            .done(function (response) {
                var total = 0, enlace;
                $.each(response, function () {
                    var estado, area2 = $("#areapadreinput").val();
...
$('#selectortipo').change(function () {
    $('#listaProyectos').empty();
    var area, tipo = $('#tipousuarioinput').val();
    ...
    $.ajax({
        url: "../proyecto?accion=ListaProyectoEvaluacionL",
        type: 'POST',
        data: {tipousuario: tipo, area: area, tipoproyecto: $(this).val(), cuatrimestre: $('#cuatrieval').val(), anio:$('#selectanio').val()},
        dataType: 'json'
    })
            .done(function (response) {
                var total = 0, enlace;
