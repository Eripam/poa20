...
<html>
    ...
    <body>
            ...
            <div class="row mt-3">
                ...
                <div class="content col-11 container-fluid">
                    <div class="tab-content ml-5 mr-5 pestania">
                        ...
                        <%}%>
                        <div class="col-12 p-0 m-0 d-none" id="colorelip"><i class="fas fa-ellipsis-h fa-2x"></i></div>
                        ...
                        <input type="hidden" name="cuatrieval" id="cuatrieval" value="<%=cua%>">
        ...
        <script src="../javascript/jsProyectosEvaluacionL.js" type="text/javascript"></script>
    </body>
</html>
