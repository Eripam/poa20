...
<html>
    ...
    <body>
        ...
        <div class="modal fade" id="eliminarModalA" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-12" style="font-weight: bold">OBSERVACIÓN:</div>
        ...
        <script src="../javascript/jsSolicitudesOPCE.js" type="text/javascript"></script>
    </body>
</html>
