            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">VERIFICAR O REGRESAR REQUERIMIENTO</h5>
                    ...
                    <div class="modal-body">
                        <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-6 mb-3">
                            <div class="row">
                                ...
                                <input type="hidden" name="idreqregresar" id="idreqregresar">
                                <textarea class="form-control" name="observacion" id="observacionreg"></textarea>
                            </div>
                        </div>
                        <input type="hidden" id="idsolicitudenviar">
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn bton modalEnvRegresar" id="modalEnvRecibir" data-estado="32">RECIBIR</button>
                        <button type="button" class="btn bton modalEnvRegresar" id="modalEnvRegresar" data-estado="47">REGRESAR</button>
            ...
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 mb-3" id="tpagas">
                                    <div class="row">
                                        <label for="recipient-name" class="col-form-label">Observación:</label>
                                        <textarea class="form-control" name="observoficio" id="observoficio" placeholder="Ingresar numero de oficio de solicitud del tramite" readonly></textarea>
                                    </div>
                                </div>
                                <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-6 mb-3">
                                    <div class="row">
                                        <label for="recipient-name" class="col-form-label">Verificar</label>
                                        <input type="checkbox" name="verificarsp" id="verificarsp" value="1">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn bton" id="modalGuardarVerificar">VERIFICAR</button>
                        <button type="button" class="btn bton" data-dismiss="modal">CANCELAR</button>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="container-fluid">
                            ...
                            <table class="table-hover table-striped table-responsive table-bordered" style="width: 100%">
            ...
            <div class="row mt-3">
                ...
                <div class="content col-11 container-fluid">
                    <div class="tab-content ml-5 mr-5 pestania">
                        ...
                        <p class="titulo2 mt-2 mb-3">LISTADO DE OBLIGACIONES PENDIENTES - COMPROMETIDOS NO DEVENGADOS - ENVIADOS</p>
                        <input type="hidden" value="<%=strCedulaUsuario%>" id="cedulaProyecto" name="cedulaProyecto">
                        <div class="tablaover">
