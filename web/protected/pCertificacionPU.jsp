...
<html>
    ...
    <body>
        ...
        <div class="modal fade bd-example-modal-xl" id="generarCPU" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title main-center" id="exampleModalLabelU" style="color:#133351">CERTIFICACIÓN PRESUPUESTARIA</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form class="modal-body" id="frmIngresarCPU">
                        <input type="hidden" name="agsolU" id="agsolU" value="<%=IntIdAreaGestion%>">
                        <input type="hidden" name="reqidcpU" id="reqidcpU">
                        <input type="hidden" name="certpidU" id="certpidU">
                        <input type="hidden" name="solicitudidcpU" id="solicitudidcpU" value="<%=request.getParameter("id")%>">
                        <input type="hidden" value="<%=strCedulaUsuario%>" id="cedulaProyectoU" name="cedulaProyectoU">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 mb-3">
                                    <div class="row">
                                        <label for="recipient-name" class="col-form-label">Tipo:</label>
                                        <select class="form-control" name="rectoringU" id="rectoringU">
                                            <option selected value="0" disabled>Seleccionar...</option>
                                            <% ResultSet rsvu;
                                                rsvu = adEjecucion.ListaTipoCP();
                                                while (rsvu.next()) {
                                            %>
                                            <option style="width: 85%; height: auto" value="<%= rsvu.getString("tcp_id")%>"><%=rsvu.getString("tcp_nombre")%></option>
                                            <%}%>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-6 mb-3">
                                    <div class="row">
                                        <label for="recipient-name" class="col-form-label" id="codigolblU">Código:</label>
                                        <input type="text" class="form-control" name="codigocpU" id="codigocpU">
                                    </div>
                                </div>
                                <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-6 mb-3">
                                    <div class="row">
                                        <label for="recipient-name" class="col-form-label" id="valorlblU">Valor:</label>
                                        <input type="text" class="form-control" name="valorcpU" id="valorcpU">
                                        <input type="hidden" class="form-control" name="valorivaU" id="valorivaU">
                                    </div>
                                </div>
                                <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 mb-3 d-none" id="porcentajecompU">
                                    <div class="row">
                                        <label for="recipient-name" class="col-form-label">Porcentaje anticipo:</label>
                                        <input type="text" class="form-control" name="porcanticipoU" id="porcanticipoU">
                                    </div>
                                </div>
                                <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-6 mb-3" id="codigoivaCPU">
                                    <div class="row">
                                        <label for="recipient-name" class="col-form-label">Código:</label>
                                        <input type="text" class="form-control" name="codigocpivaU" id="codigocpivaU">
                                    </div>
                                </div>
                                <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-6 mb-3" id="montoIvaCPU">
                                    <div class="row">
                                        <label for="recipient-name" class="col-form-label">IVA:</label>
                                        <input type="text" class="form-control" name="valorcpivaU" id="valorcpivaU" readonly>
                                    </div>
                                </div>
                                <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 mb-3">
                                    <div class="row">
                                        <label for="recipient-name" class="col-form-label">Fecha de Aprobación:</label>
                                        <input type="text" class="form-control" name="fechainU" id="fechainU">
                                    </div>
                                </div>
                                <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 mb-3">
                                    <div class="row">
                                        <label for="recipient-name" class="col-form-label">OBSERVACIÓN:</label>
                                        <textarea name="txtobservacionU" id="txtobservacionU" class="form-control"></textarea>
                                    </div>
                                </div>
                                <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 mb-3 d-none" id="recurrenteDivU">
                                    <div class="row">
                                        <div class="col-3">
                                            <label for="recipient-name" class="col-form-label">Tipo recurrente?</label>
                                        </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn bton" id="modalGuardarCPU">GUARDAR</button>
                        <button type="button" class="btn bton" data-dismiss="modal">CANCELAR</button>
                    </div>
                </div>
            </div>
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 mb-3">
                                    <div class="row">
                                        <label for="recipient-name" class="col-form-label">Fecha de Aprobación:</label>
                                        <input type="text" class="form-control" name="fechainUn" id="fechainUn">
                                    </div>
                                </div>
                                <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 mb-3" id="montoIvaCP">
                                    <div class="row">
                                        <label for="recipient-name" class="col-form-label">Observación:</label>
                                        <textarea name="txtobservaciong" id="txtobservaciong" class="form-control"></textarea>
                                    </div>
                                </div>
                                <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 mb-3 d-none" id="recurrenteDivUn">
                                    <div class="row">
                                        <div class="col-3">
                                            <label for="recipient-name" class="col-form-label">Tipo recurrente?</label>
                                        </div>
                                        <div class="col-9 row">
                                            <div class="col-2">
                                                <label class="col-form-label mr-1">SI</label><input type="radio" value="1" name="recurrenteCertUn" id="recurrenteCertUn">   
                                            </div>
                                            <div class="col-2">
            ...
            <div class="row mt-3">
                ...
                <div class="content col-11 container-fluid">
                    <div class="tab-content ml-5 mr-5 pestania">
                        ...
                        <input type="hidden" name="codigosol" id="codigosol" value="<%=request.getParameter("codigo")%>">
                        ...
                        <div class="tablaover">
                            <div class="table mt-5 table-bordered table-striped table-responsive-md table-responsive-sm tablasdiv" id="example">
                                <div class="table-azul encabezado p-0">
                                    ...
                                    <div class="p-0 estilo encabezado_7">REQ. NOMBRE</div>
                                    <div class="p-0 estilo encabezado_2">TOTAL SIN IVA</div>
                                    <div class="p-0 estilo encabezado_2">TOTAL</div>
        ...
        <script src="../javascript/jsCertificacionPU.js" type="text/javascript"></script>
    </body>
</html>
