...
<html>
    ...
    <body>
                    ...
                    <form class="modal-body" id="frmIngresarCP">
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 mb-3">
                                    <div class="row">
                                        <label for="recipient-name" class="col-form-label" id="codigolbl">Cuatrimestre:</label>
                                        <select name="cuatrimestreE" id="cuatrimestreE" class="selectpicker col-10 col-xs-10 col-md-8 p-0 reqgeneral">
            ...
            <div class="row mt-6">
                ...
                <div class="content col-11 container-fluid ">
                    <div class="tab-content ml-5 mr-5 pestania">
                        <p class="titulo2 mt-2">PROYECTOS</p>
                        <div class="row mb-3">
                            <label class="col-2 p-0 m-0">Estado:</label>
                            <select class="col-3 form-control p-0" id="sltCuatri">
        ...
        <script src="../javascript/jsProyectosAdmEv.js" type="text/javascript"></script>
