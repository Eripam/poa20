...
<html>
    ...
    <body onload="tiempos('fechacierre')">
            ...
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title main-center" id="exampleModalLabel" style="color:#133351">SOLICITUDES</h5>
                        ...
                        <div class="container-fluid">
                            <form class="row" id="FrmArchivosEvidencias" >
                                ...
                                <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 mb-3">
                                    <div class="row">
                                        <label for="recipient-name" class="col-form-label">NOTA: Subir archivos pdf o comprimidos de máximo 10 mb</label>
                                    </div>
                                </div>
                            </form>                            
                        </div>
        ...
        <div class="modal fade" id="enviarModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer" id="footereval">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="modal-body">
                        <form>
                            <div class="form-check col-6">
                                ...
                                <label class="form-check-label" for="exampleRadios1">Enviar/Aprobar/Evaluado</label>
                            </div>
                            <div class="form-check col-6">
                            ...
                            <div class="tab-content ml-5 mr-5 container-fluid">
                                <div id="componente1" class="container-fluid tab-pane active pestania"><br>
                                    ...
                                    <div class="row mt-3 p-3 align-items-center d-none" id="contenedorlogros1" style="background: rgba(19,51,81,0.1)">
                                        ...
                                        <div class="col-12 align-content-center mt-1" id="botonLog1"><button class="btn bton btn_guardar_logros" id="guardarComp1" data-id="1">GUARDAR</button></div>
                                    </div>
                                    <!--Lista Actividades-->
                                    <div class="tablaover">
                                ...
                                <div id="componente2" class="container-fluid tab-pane fade pestania"><br>
                                    ...
                                    <div class="row mt-3 p-3 align-items-center d-none" id="contenedorlogros2" style="background: rgba(19,51,81,0.1)">
                                        ...
                                        <div class="col-12 align-content-center mt-1" id="botonLog2"><button class="btn bton btn_guardar_logros" id="guardarComp2" data-id="2">GUARDAR</button></div>
                                    </div>
                                    <!--Lista Actividades-->
                                    <div class="tablaover">
                                ...
                                <div id="componente3" class="container-fluid tab-pane fade pestania"><br>
                                    ...
                                    <div class="row mt-3 p-3 align-items-center d-none" id="contenedorlogros3" style="background: rgba(19,51,81,0.1)">
                                        ...
                                        <div class="col-12 align-content-center mt-1" id="botonLog3"><button class="btn bton btn_guardar_logros" id="guardarComp3" data-id="3">GUARDAR</button></div>
                                    </div>
                                    <!--Lista Actividades-->
                                    <div class="tablaover">
        ...
        <script src="../javascript/jsProyectoCompletoEvalL.js"></script>
