    ...
    <body>
        ...
        <div class="modal fade" id="regresarModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">REGRESAR REQUERIMIENTO</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn bton" id="modalEnvRegresar">REGRESAR</button>
                        <button type="button" class="btn bton" data-dismiss="modal">CANCELAR</button>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-3">
                ...
                <div class="content col-11 container-fluid">
                    <div class="tab-content ml-5 mr-5 pestania">
                        ...
                        <input type="hidden" name="usuariorequerimiento" id="usuariorequerimiento" value="<%=cedula%>">
                        ...
                        <button class="btn bton mt-4" id="modalUnificarReq">UNIFICAR REQUERIMIENTO</button>    
                        <%}%>
                    </div>
                </div>
            </div>
        ...
        <script src="../javascript/jsRequerimientosJU.js" type="text/javascript"></script>
    </body>
</html>
