...
<html>
    ...
    <body>
                            ...
                            <table class="table table-sm mt-5 table-bordered table-hover table-striped table-responsive p-0" style="width: 100% !important">
                                <thead class="table-azul">
                                    <tr>
                                        ...
                                        <th class="text-center align-middle">CPC</th>
                        ...
                        <div class="row">
                            <div class="col-12 mb-3">
                                ...
                                <div class="col-12 p-2 row">
                                    ...
                                    <% ResultSet rsp;
                                        rsp = adEjecucion.ListarProcesos();
                                        while (rsp.next()) {
                                    %>
                                    <div class="col-1">
                                        <input type="radio" name="inpproceso" id="inpproceso" value="<%= rsp.getString("pc_id")%>">
                                    </div>
                                    <div class="col-11">
                                        <%=rsp.getString("pc_nombre")%>
                                    </div>
                                    <%}%>
                                    <textarea class="form-control" name="observacionproc" id="observacionproc" placeholder="Ingresar en caso de seleccionar otro"></textarea>
                                </div>
        ...
        <div class="modal fade" id="regresarModalVer" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn bton intrevisarv" data-estado="32" id="intreaprobar">APROBAR</button>
                        <button type="button" class="btn bton intrevisarv" data-estado="33" id="intreregresar">REGRESAR</button>
        ...
        <script src="../javascript/jsJustificativosC.js" type="text/javascript"></script>
    </body>
</html>
