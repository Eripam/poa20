...
<html>
    ...
    <body>
            ...
            <div class="row mt-3">
                ...
                <div class="content col-11 container-fluid">
                    <div class="tab-content ml-5 mr-5 pestania">
                        ...
                        <p class="titulo2 mt-2 mb-3">LISTADO OBLIGACIONES PENDIENTES Y COMPROMETIDOS NO DEVENGADOS</p>
        ...
        <script src="../javascript/jsRequerimientosOP.js" type="text/javascript"></script>
    </body>
</html>
