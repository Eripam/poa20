...
<html>
    ...
    <body>
                    ...
                    <div class="modal-body">
                        <form>
                            <div class="form-check col-6">
                                <input class="form-check-input" type="radio" name="verificarRadios" id="aprobarRadios" value="17">
                                <label class="form-check-label" for="exampleRadios1">Aprobar Planificación</label>
                            </div>
                            <div class="form-check col-6">
                                <input class="form-check-input" type="radio" name="verificarRadios" id="modificarRadios" value="18">
                                <label class="form-check-label" for="exampleRadios2">Aprobar con priorización</label>
                            </div>
                            <div class="form-check col-6">
                                <input class="form-check-input" type="radio" name="verificarRadios" id="modificarRadios" value="14">
                ...
                <div class="content col-11 container-fluid">
                        ...
                        <form class="container-fluid p-3 formulario pt-3 mt-4 needs-validation"  method="POST" action="/controladorPrueba" id="frmModProyecto" novalidate enctype="multipart/form-data" accept-charset="UTF-8">
                            ...
                            <div class="form-row d-flex justify-content-center">
                                ...
                                <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-5 mb-3">
                                    <div class="row main-center">
                                        <%if (intAnio <= 2022) {%>
                                        <label for="validationCustom01" class="col-12 col-xs-12 col-md-4 justify-content-center justify-content-md-end cross-center">Actividad Presupuestaria: </label>
                                        <%} else {%>
                    ...
                    <div class="col-12 col-xs-12 col-sm-12 col-md-12 mb-3" style="border-right: 1px solid black">
                        ...
                        <div class="form-row d-flex justify-content-center mt-3">                                
                            ...
                            <a href="pProyectoPlan.jsp?id=<%=request.getParameter("id")%>" class="btn bton mr-3 d-none" id="btn_proyecto_planificado">PLANIFICADO</a>
        ...
        <script src="../javascript/jsProyectoCompletoPrioRep.js"></script>
    </body>
</html>