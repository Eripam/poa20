...
<html>
    ...
    <body>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 mb-3">
                                    <div class="row">
                                        ...
                                        <input type="text" class="form-control" id="autoridadvis" name="autoridadvis" readonly disabled="true">
                                    </div>
                                </div>                               
                            </div>
        ...
        <script src="../javascript/jsJustificativosCAEU.js" type="text/javascript"></script>
    </body>
</html>
