            ...
            <div class="modal-dialog modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <textarea class="form-control" rows="5" id="reqtextareaenvia"></textarea>
                    </div>
            ...
            <div class="row mt-3">
                ...
                <div class="content col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 mb-3">
                    <div class="row main-center">
                        <input type="hidden" value="0" id="tipoarg">
                        ...
                        <select class="selectpicker my-select" data-live-search="true" data-width="67%" name="ag" id="ag">
                            ...
                            <%
                                ResultSet rs2 = adAreaGestion.listaAreaGestionAsignadas(cedula);
                                while (rs2.next()) {
                            %>
