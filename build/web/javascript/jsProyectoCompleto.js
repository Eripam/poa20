        ...
        dataType: 'json'
            ...
            .done(function (response) {
                $.each(response, function () {
                    ...
                    } else if ((tusu === "2" || tusu === "5" || tusu === "7" || tusu === "8" || tusu === "19") && (estadof === 0 || estadof === 5 || estadof === 7 || estadof === 12 || estadof === 13 || estadof === 14 || estadof === 20 || estadof === 25 || estadof === 26)) {
                        $("#btn_proyecto_enviar").attr("data-target", "#enviarModal");
                    } else {
                    ...
                    if (this.proceso.length > 0) {
                        ...
                        $.each(this.proceso, function (indice, accion) {
                            if (accion.proceso_codigo === "AI2016") {
                    ...
                    if (tusu === "15" && estadof === 3) {
                        ...
                        $('#btn_proyecto_eliminar').css({"display": "flex"});
                        $('#btn_proyecto_enviar').css({"display": "flex"});
                    } else if ((tusu === "2" || tusu === "5" || tusu === "7" || tusu === "8") && estadof === 1) {
                    ...
                    if ((tusu === "2" || tusu === "5" || tusu === "15" || tusu === "8" || tusu === "7" || tusu === "19" || tusu === "3") && tiempo < 0 && es) {
                        $('#btn_proyecto_enviar').addClass('d-none');
                    }
                });
        ...
        dataType: 'json'
            ...
            .done(function (response) {
                if (response.length > 0) {
                    ...
                    if (tusu === "15" && estadof === 3) {
                        $('#agregaC').removeClass('d-none');
                        $('#btn_proyecto_enviar').css({"display": "block"});
                    } else if ((tusu === "2" || tusu === "5" || tusu === "8" || tusu === "7" || tusu === "15" || tusu === "19") && (estadof === 0 || estadof === 3 || estadof === 5 || estadof === 7 || estadof === 12 || estadof === 13 || estadof === 14 || estadof === 20 || estadof === 25 || estadof === 26)) {
                        $('#agregaC').removeClass('d-none');
                        $('#btn_proyecto_enviar').css({"display": "block"});
                    } else if (tusu === "3" && (estadof === 0 || estadof === 7 || estadof === 12 || estadof === 13 || estadof === 14 || estadof === 20 || estadof === 25 || estadof === 26)) {
                        $('#agregaC').removeClass('d-none');
                        $('#btn_proyecto_enviar').css({"display": "block"});
                    } else if ((tusu === "2" || tusu === "5" || tusu === "8" || tusu === "7" || tusu === "19") && estadof === 1) {
                        $('#btn_proyecto_enviar').css({"display": "block"});
                    } else {
...
//Tipo de actividad
                ...
                } else if (numero > 1 && (tusu === "15" && estadof === 3)) {
                    $('#agregaC').removeClass('d-none');
                    $('#btn_proyecto_enviar').css({"display": "flex"});
                } else if (numero > 1 && ((tusu === "2" || tusu === "5" || tusu === "15" || tusu === "8" || tusu === "7" || tusu === "19") && (estadof === 0 || estadof === 3 || estadof === 5 || estadof === 7 || estadof === 12 || estadof === 13 || estadof === 14 || estadof === 20 || estadof === 25 || estadof === 26))) {
                    $('#agregaC').removeClass('d-none');
                    $('#btn_proyecto_enviar').css({"display": "flex"});
