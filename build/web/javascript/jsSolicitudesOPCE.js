...
function listaSolicitud(t) {
    ...
    $.ajax({
        url: "../solicitud?accion=ListaSolicitudesOPCE",
        data: {anio: $('#selectanio').val()},
        type: 'POST',
        dataType: 'json'
    })
            .done(function (response) {
                ...
                $.each(response, function () {
                    ...
                    if (this.solestado_observacion == null || this.solestado_observacion == 'null' || this.solestado_observacion == 'undefined') {
                    ...
                    if (this.solicitud_codigo === null || this.solicitud_codigo == null || this.solicitud_codigo == "") {
                        ...
                        codigo = '0' + this.solicitud_codigo + '-STP-' + $('#selectanio').val();
                    }
                    var div;
                    ...
                    if (!validacion && this.solicitud_estado !== 14 && this.solicitud_estado !== 40) {
                        ...
                        <a href="#" title="Listar Fechas de Envio" class="icon_sol" id="listarFechas" data-sol="' + this.solicitud_id + '"><i class="far fa-calendar-alt"></i></a><a href="pCertificacionPOP.jsp?id=' + this.solicitud_id + '&codigo=' + this.solicitud_codigo + '" title="Agregar certificaci\u00f3n"><i class="far fa-plus-square"></i></a>';
        ...
        dataType: 'json'
            ...
            .done(function (response) {
                ...
                $.each(response, function () {
                    ...
                    $('#listaRequerimientosSolVis').append('<tr><td class="text-center">' + this.req_id + '</td><td>' + tipo + '</td><td class="text-center">OEI-0' + this.perspectiva_id + '</td><td>' + this.req_nombre + '</td>\n\
...
$('#modalAnularSolicitud').on('click', function () {
    if ($('#txtobservanulados').val() === null || $('#txtobservanulados').val() === 'undefined' || $('#txtobservanulados').val() === "") {
        ...
        $.ajax({
            url: "../solicitud?accion=AnularSolicitudOP",
            type: 'POST',
    ...
    $.ajax({
        ...
        dataType: 'json'
            ...
            .done(function (response) {
                var num = 1, total = 0;
                $.each(response, function () {
                    var color, tipo, monto, iva, anticipo;
                    if (num % 2 === 0) {
